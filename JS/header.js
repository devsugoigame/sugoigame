...
function headerAppendFunctions() {
                                    ...
                                    success: function (retorno) {
                                        if (retorno.substr(0, 1) == "#") {
                                            ...
                                            ga('send', {
                                                ...
                                                eventAction: 'Inventario/dar_comida.php',
                                                eventLabel: 'SendGet'
                                            });
                                        }
                                    }
    ...
    $(document).on("click", "#div_icon_cartografo", function () {
        $.ajax({
            ...
            cache: false, success: function (retorno) {
                if (retorno.substr(0, 1) == "#") {
                    bancandoEspertinho(retorno.substr(1, retorno.length));
                } else {
                    ...
                    $(".select_oceano").click(function () {
                        ...
                        $("#text_coor").val("");
                        var mar = this.id;
                        var data = "mar=" + mar + "&cod=" + $("#meu_mapa").val();
                        $.ajax({
                            type: 'get',
                            ...
                            beforeSend: function () {
                                $("#mapa_cartografo_oceano")
                                    .css("background", 'url("Imagens/Mapa/Mapa_Cartografo/carregando.jpg")')
                                    .css('height', '300px')
                                    .html('');
                            }, success: function (retorno) {
                                if (retorno.substr(0, 1) == "#") {
                                    ...
                                    $("#mapa_cartografo_oceano")
                                        .css("background", 'url("Imagens/Mapa/Mapa_Cartografo/' + mar + '.jpg")')
                                        .css('height', 'auto')
                                        .html(retorno);
...
function navTimeoutFunc() {
    ...
    if (tmp <= 0) {
        ...
        document.title = transforma_tempo(tmp) + ' Sugoi Game';
    }
}
            ...
            if (retorno.redirect) {
                ...
                if (retorno.navegacao) {
                    ...
                    enviarNotificacao('Você chegou ao seu destino!', {
                        ...
                        icon: 'http://localhost/Imagens/favicon.png'
                    });
                }
