...
//            }, 15000, Phaser.Easing.Linear.None, true);
    ...
    Wait.prototype.create = function () {
        ...
        // websockets['mar'] = new ReconnectingWebSocket((location.protocol === 'https:' ? 'wss://' : 'ws://') + location.host + (location.host == 'localhost' ? ':9000/mar' : '/map-server/mar'));
        websockets['mar'] = new ReconnectingWebSocket('ws://' + location.host + ':9000/mar');
        ws = websockets['mar'];
        ws.onopen = function () {
