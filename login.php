...
<head>
    ...
    <meta property="og:url" content="http://localhost/login.php">
    ...
    <meta property="og:image" content="http://localhost/Imagens/Banners/home.jpg">
        ...
        <div class="inner">
            ...
            <ul class="actions">
                <li>
                    ...
                    <a href="#zero" class="button scrolly">Vamos jogar!</a>
            ...
            <form name="login" action="Scripts/Geral/logar.php" method="POST">
                <div class="row uniform">
                    <div class="u12">
                        ...
                        <a href="./?ses=cadastro" class="button special">
                            Cadastre-se grátis
                        </a>
                    </div>
