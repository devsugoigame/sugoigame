...
$_SERVER["HTTP_HOST"] = isset($argv[1]) ? $argv[1] : "sugoi-game.tk";

require __DIR__ . '/vendor/autoload.php';
require __DIR__ . '/../../Includes/database/mywrap.php';
require __DIR__ . '/../../Classes/requires.php';
require __DIR__ . "/../../Funcoes/requires.php";
require __DIR__ . "/../../Constantes/requires.php";
